                ...
                )
{
    ...
    *folha_sprites_inimigo = al_load_bitmap("/home/jglord/Workspace/Projeto-ED1/projeto_jogo/projeto_allegro/imagens/imgsBoneco/inimigo.png");
    ...
    *folha_sprites_personagem = al_load_bitmap("/home/jglord/Workspace/Projeto-ED1/projeto_jogo/projeto_allegro/imagens/imgsBoneco/boneco.bmp");
    ...
    al_convert_mask_to_alpha(*folha_sprites_inimigo, al_map_rgb(255, 0, 255));


    //carrega o fundo
    *fundo = al_load_bitmap("/home/jglord/Workspace/Projeto-ED1/projeto_jogo/projeto_allegro/imagens/imgsBoneco/Cenario1.png");
    if (!*fundo){
